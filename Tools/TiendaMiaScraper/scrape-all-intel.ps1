$urls = Get-Content 'C:\Notas\Milton\TiendaMia-Intel-Notebooks-URLs.txt' | Where-Object { $_ -match '^https://' }

Write-Host '=== Scraping 24 Intel Notebooks ===' -ForegroundColor Cyan
