    ...
    public partial class AddProductSearchIndexes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                "ON [Catalog].[Products] (IsActive, DiscountPercentage) " +
            ...
            migrationBuilder.Sql(
                ...
                "ON [Catalog].[ProductInStock] (ProductId, Stock) " +
                "WHERE Stock > 0");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP INDEX IF EXISTS IX_ProductInStock_Stock ON [Catalog].[ProductInStock]");
            ...
            migrationBuilder.Sql("DROP INDEX IF EXISTS IX_Products_Discount_Active ON [Catalog].[Products]");
